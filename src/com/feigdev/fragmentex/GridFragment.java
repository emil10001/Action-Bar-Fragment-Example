...
public class GridFragment extends FragmentActivity {
    int mStackLevel = 1;
    ...
    void addFragmentToStack() {
        ...
        Fragment newFragment = Grid.newInstance(mStackLevel);

        // Add the fragment to the activity, pushing this transaction
        // on to the back stack.
        FragmentTransaction ft = getSupportFragmentManager().beginTransaction();
        ft.replace(R.id.myGrid, newFragment);
        ft.setTransition(FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        ft.addToBackStack(null);
        ft.commit();
    }

    public static class Grid extends Fragment {
         ...
         */
        public static Grid newInstance(int index) {
        	Grid f = new Grid();
